...
const Register: React.FC = () => {
  ...
  const { register: regStore, isLoading, error, clearError, user } = useAuthStore();
  ...
  const onSubmit = async (data: FormData) => {
    try {
      await regStore(data.name, data.email, data.password, data.role);
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="glass-card p-8">
          <h2 className="text-xl font-bold text-slate-100 mb-1">Create an account</h2>
          <p className="text-slate-400 text-sm mb-6">Join AgroLoop today</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input {...register('name')} placeholder="John Doe" className="input-field pl-10" id="reg-name" />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input {...register('email')} type="email" placeholder="you@example.com" className="input-field pl-10" id="reg-email" />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input {...register('password')} type="password" placeholder="••••••••" className="input-field pl-10" id="reg-password" />
              </div>
              {errors.password && <p className="text-red-400 text-xs mt-1">{errors.password.message}</p>}
            </div>

            <div>
              <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1.5">I am a…</label>
              <div className="relative">
                <Briefcase className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500" />
                <select {...register('role')} className="select-field pl-10" id="reg-role">
            ...
            <button type="submit" disabled={isLoading} className="btn-primary w-full mt-2" id="reg-submit">
